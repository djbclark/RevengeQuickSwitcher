...
| Version | Check plugin metadata if Revenge shows it | **4.4.2** |
...
## Quick checklist — v4.4.2 device QA (A1)
...
[ ] Plugin installs / updates on Revenge without crash (shows 4.4.2 if version visible)
